...
import hero from "../../assets/images/about/herobackground.jpg";
...
function About() {
  ...
  <section id="about-us" className="section about-us-div">
    <div className="about-us-info">
      <h1>About Us</h1>
      <p>
        SportTrackr is a platform for football enthusiasts to easily find
        competitive leagues, track personal performance, and stay connected
  ...
  <section id="mission" className="section our-mission-div">
    <div className="our-mission-info">
      <h1>Our Mission</h1>
      <p>
        Creating both enjoyable and competitive football groups with the help
        of SportTrackr, football players in all levels enjoy a better football
        experience by keeping track of their own accomplishments, interacting
        with teammates.
      </p>
    </div>
    <img className="our-mission-img" src={mission} alt="Football app" />
  </section>
  ...
  <section id="story" className="section our-story-div">
    <div className="our-story-info">
      <h1>Our Story</h1>
      <p>
        In 2024, fellow GBC undergraduate students Aum Zaveri, Mia Truong,
        Elio Fezoralli, Kate Labis noticed that sports enthusiasts struggle to
        find organized and user-friendly platforms that allow them to
        participate in competitive leagues, track their performance, and
        communicate effectively with teammates.
      </p>
    </div>
    <img className="our-story-img" src={story} alt="Four founders" />
  </section>
  ...
  <section id="contact" className="section contact-us">
    ...
    <img className="contact-us-img" src={canada} alt="Canada flag" />
  </section>
